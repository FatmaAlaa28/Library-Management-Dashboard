...
<div class="d-flex justify-content-center align-items-center" style="height: 80vh;">
    <div class="card p-4 shadow" style="width: 60%;">
        ...
        <form action="{{ route('books.update') }}" method="POST">
            ...
            <div class="row mb-3">
                 <div class="col-sm-10">
                    <input type="number" class="form-control" id="id" name="id" value="{{ $book->id }}" hidden>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="description" name="description" rows="3" value="{{ $book->description }}"></textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="student_id" name="student_id" value = "{{ $book->student_id }}">
                </div>
            </div>
